...
# Load .env file with override to ignore parent process env variables
...
try:
    ...
    std_logging.warning(f"Telemetry setup skipped: {e}")
try:
    ...
    class DummyLogger:
        def log_struct(self, data, **kwargs):
            std_logging.info(f"Feedback Log: {data}")
    logger = DummyLogger()
allow_origins = (
...
app.title = "trip-pilot-ai"
app.description = "API for interacting with the Agent trip-pilot-ai"
